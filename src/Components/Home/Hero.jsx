        ...
        <div
            ...
            <div className="1024px:w-[80%] 1360px:w-[70%] text-center mx-auto w-full">
                ...
                <h1
                    ...
                    {t('hero.title_prefix')} <span className="text-[#2498b5] dark:text-[#41bfdb]">{t('hero.title_highlight')}</span>
                </h1>
                ...
                <p className='mt-6 text-gray-500/80 dark:text-darkSubTextColor/70 text-[0.9rem] mb-1 font-medium'>{t('hero.compatible_with')}</p>
